...
<Text style={{color :'#FFFFFF80' , fontSize : 12,marginTop : height *0.01}}>{item.text2}</Text>
  ...
  ListFooterComponent={() => (
    <>
      ...
      <SongInfoButton source={IMAGES.IMAGE_13} Text1="Inside Out" Text2="The Chainsmokers, Charlee" icon={<SVG.Three_dots />} />
      <SongInfoButton source={IMAGES.IMAGE_14} Text1="Young" Text2="The Chainsmokers" icon={<SVG.Three_dots />} />
      <SongInfoButton source={IMAGES.IMAGE_15} Text1="Beach House" Text2="The Chainsmokers - Sick" icon={<SVG.Three_dots />} />
      <SongInfoButton source={IMAGES.IMAGE_10} Text1="Kills You Slowly" Text2="The Chainsmokers - World" icon={<SVG.Three_dots />} />
      <SongInfoButton source={IMAGES.IMAGE_11} Text1="Setting Fires" Text2="The Chainsmokers, XYLO -" icon={<SVG.Three_dots />} />
      <SongInfoButton source={IMAGES.IMAGE_12} Text1="Somebody" Text2="The Chainsmokers, Drew" icon={<SVG.Three_dots />} />
    </>
  )}
/>
